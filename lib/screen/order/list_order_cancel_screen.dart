...
import 'package:admin/screen/order/order_detail_cancel_screen.dart';
import 'package:cached_network_image/cached_network_image.dart';
import 'package:flutter/material.dart';
import 'package:flutter_bloc/flutter_bloc.dart';
import 'package:intl/intl.dart';

class ListOrderCancelScreen extends StatefulWidget {
  const ListOrderCancelScreen({super.key});

  @override
  State<ListOrderCancelScreen> createState() => _ListOrderCancelScreenState();
}

class _ListOrderCancelScreenState extends State<ListOrderCancelScreen> {
  final currencyFormatter = NumberFormat.currency(locale: 'vi_VN', symbol: 'đ');
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    context.read<OrderBloc>().add(OrderGetList(status: OrderStatus.CANCELED));
  }
      ...
      body: BlocBuilder<OrderBloc, OrderState>(
        builder: (context, state) {
          ...
          if (state is OrderError) {
            print("Tải đơn hàng canceled thất bại${state.message}");
            return Center(
              child: Text(
                ...
                return InkWell(
                    onTap: () {
                      Navigator.push(context,
                        ...
                        return OrderDetailCancelScreen(order: orders[index]);
                      }));
                    },
            ...
            child: Row(
              ...
              children: [
                ...
                Container(
                  ...
                  child: Text(
                    OrderStatus.CANCELED.description,
                    style: const TextStyle(
                      color: Colors.black,
                  ...
                  children: [
                    OutlinedButton(
                      onPressed: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) {
                          return OrderDetailCancelScreen(order: order);
                        }));
                      },
                      style: OutlinedButton.styleFrom(
