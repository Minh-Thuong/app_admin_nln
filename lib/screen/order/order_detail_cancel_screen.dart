...
class OrderDetailCancelScreen extends StatefulWidget {
  final Order order;
  const OrderDetailCancelScreen({super.key, required this.order});

  @override
  State<OrderDetailCancelScreen> createState() =>
      _OrderDetailCancelScreenState();
}

class _OrderDetailCancelScreenState extends State<OrderDetailCancelScreen> {
  Order? _order;
  @override
  void initState() {
    super.initState();
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) {
        if (didPop) {
          context
              .read<OrderBloc>()
              .add(OrderGetList(status: OrderStatus.CANCELED));
        }
      },
