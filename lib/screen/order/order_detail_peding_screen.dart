...
class OrderDetailPedingScreen extends StatefulWidget {
  final Order order;
  const OrderDetailPedingScreen({super.key, required this.order});

  @override
  State<OrderDetailPedingScreen> createState() =>
      _OrderDetailPedingScreenState();
}

class _OrderDetailPedingScreenState extends State<OrderDetailPedingScreen> {
    ...
    return PopScope(
      ...
      onPopInvokedWithResult: (didPop, result) {
        if (didPop) {
          context
              .read<OrderBloc>()
              .add(OrderGetList(status: OrderStatus.PENDING));
        }
      },
