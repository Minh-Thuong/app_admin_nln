...
import 'package:admin/models/order_detail.dart';
import 'package:admin/models/order_model.dart';
import 'package:admin/models/order_status.dart';
import 'package:admin/screen/order/order_detail_peding_screen.dart';
...
class ListOrderPedingScreen extends StatefulWidget {
  const ListOrderPedingScreen({super.key});

  @override
  State<ListOrderPedingScreen> createState() => _ListOrderPedingScreenState();
}

class _ListOrderPedingScreenState extends State<ListOrderPedingScreen> {
  final currencyFormatter = NumberFormat.currency(locale: 'vi_VN', symbol: 'đ');
  @override
  void initState() {
    // TODO: implement initState
    super.initState();
    context.read<OrderBloc>().add(OrderGetList(status: OrderStatus.PENDING));
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Danh sách đơn hàng chờ duyệt'),
        centerTitle: true,
      ...
      body: BlocBuilder<OrderBloc, OrderState>(
        builder: (context, state) {
          ...
          if (state is OrderError) {
            print("Tải đơn hàng pending thất bại${state.message}");
            return Center(
              child: Text(
                ...
                return InkWell(
                    onTap: () {
                      Navigator.push(context,
                        ...
                        return OrderDetailPedingScreen(order: orders[index]);
                      }));
                    },
                  ...
                  children: [
                    OutlinedButton(
                      onPressed: () {
                        Navigator.push(context,
                            MaterialPageRoute(builder: (context) {
                          return OrderDetailPedingScreen(order: order);
                        }));
                      },
                      style: OutlinedButton.styleFrom(
